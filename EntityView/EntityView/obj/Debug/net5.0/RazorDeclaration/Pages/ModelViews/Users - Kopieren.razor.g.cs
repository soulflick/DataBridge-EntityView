...
#nullable disable
#nullable restore
#line 3 "C:\Workspace\projects\EntityView\EntityView\Pages\ModelViews\Users - Kopieren.razor"
...
#nullable disable
#nullable restore
#line 4 "C:\Workspace\projects\EntityView\EntityView\Pages\ModelViews\Users - Kopieren.razor"
...
#nullable disable
#nullable restore
#line 5 "C:\Workspace\projects\EntityView\EntityView\Pages\ModelViews\Users - Kopieren.razor"
...
#nullable disable
    ...
    public partial class Users___Kopieren : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 12 "C:\Workspace\projects\EntityView\EntityView\Pages\ModelViews\Users - Kopieren.razor"
...
#nullable disable
#nullable restore
#line 65 "C:\Workspace\projects\EntityView\EntityView\Pages\ModelViews\Users - Kopieren.razor"
...
#nullable disable
#nullable restore
#line 72 "C:\Workspace\projects\EntityView\EntityView\Pages\ModelViews\Users - Kopieren.razor"
        ...
        private void SortTable(string columnName)
        {
            ...
            {
                _users = _users.OrderBy(x => x.GetType().GetProperty(columnName).GetValue(x, null)).ToList();
            ...
            else
            {
                ...
                {
                    _users = _users.OrderByDescending(x => x.GetType().GetProperty(columnName).GetValue(x, null)).ToList();
                }
                else
                {
                    _users = _users.OrderBy(x => x.GetType().GetProperty(columnName).GetValue(x, null)).ToList();
